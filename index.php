      ...
      <div id="bioexcerpt" >
        ...
        <div id="biotextauthor">
          <p>
            ...
            <p  class="biotextauthor_info">Named one of the top 50 leaders in the field of New Media by <em>The Hollywood Reporter</em>, director/filmmaker/author Laurent Bouzereau is one of the most sought-after talents in the industry. <a href="about.php" style="text-decoration:none;"><span class="biotextauthor_readmore">&gt;Read more</span></a>
            </p>
          </p>
        </div>
        ...
        <p class="biopost_text">
              <div class="biopost_text" id="marginFirstOp"><a  href="dontsay.php" style="text-decoration:none;">Don’t Say No Until I Finish Talking</a></div>
              <div class="biopost_text"><a href="emptypost.php" style="text-decoration:none;">Night at the Movies: Episode 6</a></div>
              <div class="biopost_text"><a href="polpost.php" style="text-decoration:none;">Roman Polanski: A Film Memoir</a></div>
              <div class="biopost_text"><a href="emptypost.php" style="text-decoration:none;">Behind the Scenes</a></div>
              <div class="biopost_text"><a href="piecepost.php" style="text-decoration:none;">Hitchcock: Piece by Piece</a></div>
            </p>
          </p>
        </div>
      </div>
